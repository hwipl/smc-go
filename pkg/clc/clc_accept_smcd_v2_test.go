...
func TestParseSMCDv2Accept(t *testing.T) {
	// prepare message
	msgBytes := "e2d4c3c4" + "02" + "004e" + "2" + "1" + "0123456789abcdef" +
	...
	if clcLen != AcceptSMCDv2Len {
		t.Errorf("clcLen = %d; want %d", clcLen, AcceptSMCDv2Len)
	}

	// check output message without reserved fields
	want := "Accept: Eyecatcher: SMC-D, Type: 2 (Accept), Length: 78, " +
		"Version: 2, First Contact: 0, Path: SMC-D, " +
	...
	want = "Accept: Eyecatcher: SMC-D, Type: 2 (Accept), " +
		"Length: 78, Version: 2, First Contact: 0, Reserved: 0x0, " +
		...
		"ISMv2 VCHID: 291, EID: ThisIsSMCv2EID01, " +
		"Reserved: 0x0000000000000000, Trailer: SMC-D"
	got = clc.Reserved()
	if got != want {
...
func TestParseSMCDv2FCEAccept(t *testing.T) {
	// prepare message
	msgBytes := "e2d4c3c4" + "02" + "0072" + "2" + "9" + "0123456789abcdef" +
		"0123456789abcdef" + "ff" + "1" + "0" + "0000" + "ffffffff" +
		"0123" +
		"546869734973534d4376324549443031" +
		"00000000000000000000000000000000" +
	...
	// check output message without reserved fields
	want := "Accept: Eyecatcher: SMC-D, Type: 2 (Accept), Length: 114, " +
